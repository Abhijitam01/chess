...
export declare const GameScalarFieldEnum: {
    ...
    readonly pgn: "pgn";
    readonly whiteRatingChange: "whiteRatingChange";
    readonly blackRatingChange: "blackRatingChange";
...
export declare const GameMoveScalarFieldEnum: {
    ...
    readonly moveSan: "moveSan";
    readonly fen: "fen";
    readonly timeLeftWhite: "timeLeftWhite";
    readonly timeLeftBlack: "timeLeftBlack";
    readonly createdAt: "createdAt";
};
