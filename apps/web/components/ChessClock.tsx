    ...
    <div className="bg-zinc-900/50 p-4 rounded-xl border border-white/5 space-y-3">
      ...
      <div className={`
        ...
        ${turn === 'w' 
          ...
          : 'bg-zinc-800/50 border border-white/5 opacity-60'
        }
      `}>
        <div className="flex items-center gap-2">
          <div className={`w-2 h-2 rounded-full ${turn === 'w' ? 'bg-emerald-500 animate-pulse' : 'bg-zinc-600'}`} />
      ...
      `}>
        <div className="flex items-center gap-2">
          <div className={`w-2 h-2 rounded-full ${turn === 'b' ? 'bg-emerald-500 animate-pulse' : 'bg-zinc-600'}`} />
